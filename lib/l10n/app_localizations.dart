...
abstract class AppLocalizations {
  ...
  /// Status text when VPN is active
  ///
  /// In en, this message translates to:
  /// **'VPN Active'**
  String get vpnActive;

  /// Status text when VPN is inactive
  ///
  /// In en, this message translates to:
  /// **'VPN Inactive'**
  String get vpnInactive;

  /// Label for primary DNS field
  ///
  /// In en, this message translates to:
  /// **'Primary'**
  String get primary;

  /// Label for secondary DNS field
  ///
  /// In en, this message translates to:
  /// **'Secondary'**
  String get secondary;

  /// Label for DNS presets section
  ///
  /// In en, this message translates to:
  /// **'Presets'**
  String get presets;
  ...
  /// Google DNS preset button
  ///
  /// In en, this message translates to:
  /// **'Google'**
  String get google;

  /// Cloudflare DNS preset button
  ///
  /// In en, this message translates to:
  /// **'Cloudflare'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Failed to start VPN: {error}'**
  String failedToStartVpn(String error);

  /// Error message when VPN fails to stop
  ///
  /// In en, this message translates to:
  /// **'Failed to stop VPN: {error}'**
